...
public static class QRCodeHtmlHelper
{
    ...
    public static string CreateQrData(string trackingNumber, string password)
    {
        return HttpUtility.UrlEncode( string.Format("trackingNumber={0};password={1}",trackingNumber, password)); 
    }
